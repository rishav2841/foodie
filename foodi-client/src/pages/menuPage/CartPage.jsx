...
const CartPage = () => {
  ...
  const placeOrderHandler = async () => {
    try {
      ...
      // setorderId(data.paymentResult._id)
      // console.log(`paymentResult is ${data.paymentResult._id}`);
      navigate(`/process-checkout/${data.paymentResult._id}`);
    } catch (err) {
      alert(err)
    }
  };
...

      {
        ...
        <div className="flex flex-col md:flex-row justify-between items-start my-12 gap-8">
          ...
          <div className="md:w-1/2 space-y-3">
            ...
            <Link onClick={placeOrderHandler} className="btn btn-md bg-green text-white px-8 py-1">
